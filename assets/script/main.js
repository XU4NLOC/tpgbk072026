...
$(document).ready(function () {
    ...
    $('#formbaogia').submit(function (e) {
        ...
        //var self = $(this);
        if (requestcount <= 9999999) {
		  const formData = new FormData();
		  formData.append("entry.1712785709", document.getElementById("contactFormName").value);
		  formData.append("entry.584034272", document.getElementById("contactFormPhone").value);
		  formData.append("entry.1550265509", document.getElementById("contactFormEmail").value);

		  fetch("https://docs.google.com/forms/d/e/1FAIpQLSeWfmV2bgRPlaZNdK6Wlyi-CsKvbV4_yH8BgnXcSLrNiuLerw/formResponse", {
			method: "POST",
			mode: "no-cors",
			body: formData
		  })
		...
		$('#contactFormName, #contactFormPhone, #contactFormEmail').val('');
    });
    /* scroll top */
