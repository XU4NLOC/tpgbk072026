    ...
    option.height="100%"
       ...
       let $fotoramaDiv= $('.fotorama').fotorama(option);
            ...
            $('body').append(
                '<div class="imgal-modal">'+
                '<span id="imgal-modal-close"">X</span>'+
                ' <iframe class="videoytb" style="max-width:100%" width="560" height="315" src="https://www.youtube.com/watch?v=nUR1TIjL4BE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'+
                '</div'
            )
           if( $(window).width()>1000)
           {
